...
const formMonths = document.querySelector(".form-months") as HTMLFormElement
const inputMonths = document.querySelector("#months") as HTMLInputElement

formMonths.addEventListener("submit", (e:Event)=>{
    e.preventDefault()
